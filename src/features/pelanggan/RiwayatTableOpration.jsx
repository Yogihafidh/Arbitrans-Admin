...
function RiwayatTableOpration() {
  const navigate = useNavigate();
  return (
    <div className="flex flex-shrink justify-between gap-2 sm:flex-shrink-0 sm:flex-row sm:items-center">
      <div className="flex items-center gap-4">
        <ButtonIcon
          onEvent={() => navigate("/pelanggan")}
          className="bg-netral-100 border-netral-400 text-natural-900 hover:bg-netral-200 h-fit w-fit rounded-lg border-2 p-2"
          icon={
            <svg
              width="24"
              height="24"
...
export default RiwayatTableOpration;
